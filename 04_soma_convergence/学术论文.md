...
**结论:** 所有序列长度的误差均为 **0.00%**，prefill 与 full_forward 完全一致。
...
- **无损表示**: 与标准 Attention 误差 0.00%
- **显著加速**: 7B 模型端到端加速 4.16x
